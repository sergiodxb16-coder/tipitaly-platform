    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-orange-50 to-white px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-orange-600">TipItaly B2B</h1>
          <p className="mt-2 text-gray-600">Portale Agenzie Partner</p>
        </div>
          ...
          <form action={sendMagicLink} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="agenzia@esempio.it"
              />
            </div>
            <button
              type="submit"
        ...
        <p className="mt-6 text-center text-xs text-gray-500">
          Accesso riservato alle agenzie partner TipItaly. Nessuna password richiesta.
        </p>
      </div>
    </main>
  );
