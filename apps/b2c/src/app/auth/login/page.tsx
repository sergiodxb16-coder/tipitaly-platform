    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-orange-50 to-white px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-orange-600">TipItaly</h1>
          <p className="mt-2 text-gray-600">Portale Viaggiatori</p>
        </div>
        ...
        <p className="mt-6 text-center text-xs text-gray-500">
          Accesso riservato ai titolari di TipItaly Card. Nessuna password richiesta.
        </p>
      </div>
    </main>
  );
